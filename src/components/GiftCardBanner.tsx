    ...
    <section className="border-y">
      <div className="grid md:grid-cols-2">
        ...
        <div className="flex flex-col items-center justify-center px-8 py-16 text-center md:px-16">
          <h2 className="font-serif-display text-4xl font-light tracking-wide md:text-5xl mb-4">Gift FLUR</h2>
          <p className="font-sans-body text-[13px] text-muted-foreground leading-relaxed mb-8 max-w-sm">
            Not sure what to get? Give them the gift of choice with a FLUR gift card. Available in any amount.
          </p>
          <Link
